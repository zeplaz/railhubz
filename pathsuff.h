...
public:
  ...
  static double Calculate(const graph_type& G, float nd1, float nd2)
  {
...
sf:Vector2f node_postion;

extra_info _extrainfo;
double priority;pathstyff
public :
Routing_graph_node():_extrainfo(extra_info()){}
Routing_graph_node(int idx, sf::Vector2f loc, double piori) : graph_node(idx), node_postion(loc),
                    _extrainfo(extra_info());
{}

virtual ~Routing_graph_node(){};
